"""
Simple decorator for automatic telemetry tracking.
        ...
        def wrapper(self, *args, **kwargs) -> Any:
            ...
            try:
                ...
                if hasattr(result, 'metadata') and result.metadata:
                    is_fallback = result.metadata.get('is_fallback', False) or \
                                result.metadata.get('sql_fallback_flag', False)
                ...
                if completion_tokens == 0 and hasattr(result, 'answer') and result.answer:
